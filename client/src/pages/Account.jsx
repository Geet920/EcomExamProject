...
import UpdateUserModel from "../components/Model/UpdateUserModel";
      ...
      <MainContainer>
        ...
        <Wrapper>
          ...
          <InfoContainer>
            ...
            <EditButton>
              <EditIcon onClick={() => handleModel("Username")} />
            </EditButton>
          </InfoContainer>
          <InfoContainer>
            <Category>
            ...
            <EditButton>
              <EditIcon onClick={() => handleModel("Email")} />
            </EditButton>
          </InfoContainer>
          <InfoContainer>
            <Category>
            ...
            <EditButton>
              <EditIcon onClick={() => handleModel("Password")} />
            </EditButton>
          </InfoContainer>
        </Wrapper>
      </MainContainer>
